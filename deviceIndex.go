...
func AddDevice() TDeviceDB {
	...
	//DB.DeviceDB["Hermes Chariot"].cyberSoftware = make([]*TcyberProgram, 0, 99)
	//////////////
...
func preaparePrograms() *TProgram {
	...
	prgList.programStatus = append(prgList.programStatus, "notAvailable")
	...
	for i := range prgList.programName {
		prgList.programRating = append(prgList.programRating, 0)
		i++
		i--
	}
